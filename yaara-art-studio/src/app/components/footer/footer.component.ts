...
export class FooterComponent {
  ...
  privacyPolicyContent = `
    ...
    <h2>1. מבוא</h2>
    <p>מדיניות פרטיות זו מפרטת כיצד אנו אוספים, משתמשים ומגייסים את המידע האישי של המשתמשים באתר סטודיו יערה ("האתר", "אנו", "שלנו"). מדיניות זו חלה על כל המידע הנמסר לנו, בין אם במהלך השימוש באתר ובין אם במהלך הרשמה לשירותים השונים.</p>
  ...
  termsOfServiceContent = `
    <h1>תנאי שימוש</h1>
    <h2>1. מבוא</h2>
    <p>ברוכים הבאים לאתר סטודיו יערה ("האתר", "אנו", "שלנו"), המציע קורסים, שיעורים וסדנאות ציור. כל שימוש באתר ובשירותים הניתנים בו כפוף לתנאים המפורטים במסמך זה. כל אדם המשתמש באתר מאשר כי הוא קרא, הבין ומסכים להיכנס להסכם זה.</p>
