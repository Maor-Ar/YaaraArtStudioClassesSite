...
export class ClassesAlternatingComponent implements OnInit, OnChanges {
  ...
  classes: ArtClass[] = [
    ...
    {
      title: 'בוטניקה ונופים',
      description: 'בשיעורים האלה נלמד איך לעבוד נכון עם צבעים, לערבב כמו שצריך, ולשלב אותם בצורה מדויקת שיוצרת עומק, נפח וטקסטורות שמחיות את תחושת הטבע בציור. השיעורים האלו מעט יותר משוחררים ומושלמים למי שמעבר ללמידה רוצה לאפשר לעצמו פשוט להנות מהתהליך, להשתחרר ולהתחבר לציור בצורה חופשית וטבעית. תקבלו כלים, תלמדו טכניקות, אבל הכי חשוב- תשתחררו ותהנו.',
      days: 'ימי שלישי',
      times: ['10:30-12:00', '12:00-13:30'],
      imageUrl: 'assets/images/botanicsAndSineries.jpeg'
    },
    {
