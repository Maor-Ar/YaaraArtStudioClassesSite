...
export class ClassesAlternatingComponent implements OnInit, OnChanges {
  ...
  classes: ArtClass[] = [
    ...
    {
      title: 'ציור קונסטרקטיבי',
      description: 'בשיעורים האלו נלמד לצייר דמויות מתוך הבנה של מבנה ונפח, ולא רק מהעתקה של רפרנס. נתרגל חשיבה תלת ממדית ונלמד איך לבנות דמות מתוך פישוט של צורות בסיס ובניית נפחים! השיעורים האלו מעט יותר לימודיים והם מושלמים למי שרוצה לפתח צד יצירתי יותר או להתחיל לבנות יצירות מקוריות יותר. המטרה היא לתת כלים שיאפשרו לצייר מתוך שילוב של התבוננות ודמיון, ולהרגיש חופש וביטחון גם כשאין רפרנס מול העיניים.',
      days: 'ימי שני',
      times: ['18:00-19:30', '19:30-21:00'],
      imageUrl: 'https://github.com/user-attachments/assets/61e25c95-0538-48ad-ab2f-bcac6f4e766a'
    },
    {
